...
if (empty($_GET["codigo_usuario"])){
    $res = mysqli_query($db_conec_users, "SELECT * FROM usuarios WHERE id_usuario = ". $sessao);
    $linha = mysqli_fetch_row($res);
...
<body>
    ...
    <header>
        ...
        <!-- DROPDOWN -->
        <ul id="dropdown-adicionar" class="dropdown-content">
            <li><a href="#adicionarPrato-modal" class="modal-trigger">Prato</a></li>
            <li><a href="#adicionarBebida-modal" class="modal-trigger">Bebida</a></li>
            <li><a href="#adicionarCombo-modal" class="modal-trigger">Combo</a></li>
        </ul>
    ...
    <section>
        ...
        <div class="modal" id="adicionarPrato-modal">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="inserir.php">
        ...
        <div class="modal" id="adicionarCombo-modal">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="inserir.php">
                    <input type="text" name="combo" placeholder="Nome do combo" maxlength="30" autocomplete="off"><br>
                    <input type="text" name="descricaoCombo" placeholder="Descrição do combo" autocomplete="off"><br>
